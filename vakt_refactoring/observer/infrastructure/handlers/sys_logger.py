...
class SysLogger(BaseHandler):
    ...
    something changes, providing a continuous audit trail of what happened during
    event processing.
    ...
    Why _last_ctx is compared on every can_handle call:
        ...
        a new performed action or a change in processed handlers.
    ...
    Notes:
        ...
        - ToolKit is accepted but ignored - SysLogger does not modify the
            file system and does not require path locking, snapshots registry
            or ignoring_paths to perform its work.
    ...
    def __init__(self, toolkit: ToolKit) -> None:
        ...
        ToolKit is accepted but ignored.
        """
    ...
    def can_handle(self, ctx: EventContext) -> bool:
        ...
        return (
            ctx.performed != self._last_ctx.performed
    ...
    def handle(self, ctx: EventContext) -> None:
        ...
        self._log.log(
            level,
            "event=[%s] path=%s | performed=%s | handlers=%d/%d",
