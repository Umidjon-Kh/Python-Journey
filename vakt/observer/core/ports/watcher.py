...
class BaseWatcher(ABC):
    ...
    to events after they are placed into the buffer - that is the
    responsibility of the Dispatcher layer.
    ...
    that is shared with the Dispatcher Thread.
    ...
    def start(self) -> None:
        ...
        Why events() is split from start():
